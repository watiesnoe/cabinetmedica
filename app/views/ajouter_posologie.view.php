                                                ...
                                                <form action="" method="post">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 col-lg-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="hidden"  name="num_posologie" value="<?=$posologie->num_posologie?>">
                                                                    <input type="text" class="form-control" id="type_posologie" name="type_posologie" placeholder="Entrer le nom de structure" value="<?=$posologie->type_posologie?>">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <?php else :?>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 col-lg-12">
                                                                <div class="form-group">
                                                                    <label for="structure">Forme de posologie</label>

                                                                    <input type="text" class="form-control" id="posologie" name="posologie" placeholder="" value="">
                                                                </div>

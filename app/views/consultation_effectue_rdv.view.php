                                                    ...
                                                    <?php foreach ($patients as $patient) : ?>
                                                        <?php foreach ($consultations as $consultation) : ?>
                                                            <?php  if(isset($_SESSION['role']) and $_SESSION['role']==='supAdmin'||$_SESSION['role']==='admin') : ?>
                                                                ...
                                                                <?php if ($patient->num_patient ===  $rdv->idpatient and 
                                                                $consultation->idRendezVous===$rdv->num_rendez ): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="drodown">
                                                                                ...
                                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                                    ...
                                                                                    <a class="dropdown-item" href="<?=ROOT?>/Consultations/edit_rdv/<?=$rdv->num_rendez?>">Edit</a>
                                                                                    ...
                                                                                    <a class="dropdown-item" href="<?=ROOT?>/Analyses/AjoutAnalyse/<?=$rdv->idpatient?>">Analyse</a>

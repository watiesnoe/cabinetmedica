                            ...
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <BR>
                                        <h3 class="nk-block-title page-title">Liste d'attente</h3>
                                        ...
                                        <div class="toggle-wrap nk-block-tools-toggle">
                                            ...
                                            <div class="toggle-expand-content" data-content="pageMenu">
                                                <ul class="nk-block-tools g-3">
                                                    <li class="nk-block-tools-opt"><a href="<?=ROOT?>/Tickets/" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Nouveau ticket</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head-content -->
                                                                        ...
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="<?=ROOT?>/PDF/PdfTicket/<?=$ticket->num_ticket?>" target="_blank"><em class="icon ni ni-printer-fill"></em><span>Imprimer</span></a></li>
                                                                                    <li><a href="<?=ROOT?>/Tickets/edit/<?=$ticket->num_ticket?>"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>

                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <select class="form-select js-select2" data-search="on" id='idFournisseur'>
                                                                <option value="<?=$commande_fournisseur->id_fournisseur?>" selected>
                                                                    <?=$commande_fournisseur->nom_fournisseur.' '.
                                                                    $commande_fournisseur-> adresse_fournisseur.' '.
                                                                    $commande_fournisseur->telephone_fournisseur ?>
                                                                </option>
                                                                <?php foreach ($fournisseurs as $item) :?>
                                                                    <?php if ($commande_fournisseur->id_fournisseur!==$item-> nom_fournisseur) : ?>
                                                                        <option value="<?=$item->id_fournisseur?>"><?=$item-> nom_fournisseur.' '.$item-> adresse_fournisseur.' '.$item->telephone_fournisseur 	?></option>
                                                                    <?php endif; ?>
                                                                <?php endforeach?>
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="card card-bordered card-preview">
                                                        <div class="card-header  bg-secondary text-center">
                                                            <input type="hidden" class="form-control" name="edit" id="edit" value="<?=$id?>">
                                                                    ...
                                                                    <span class="tb-product">
                                                                        ...
                                                                        <td class="nk-tb-col nk-tb-col-check">
                                                                            <div class="custom-control custom-control-sm custom-checkbox notext">
                                                                                <?php if(in_array($medicament->idMedicament,$data)) :?>
                                                                                    <input type="checkbox" class="custom-control-input  commande" name="commande" checked id="<?=$medicament->idMedicament?>" value="<?=$medicament->idMedicament?>">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="commande_medica" align="right">
                                                                <button class="btn btn-success pull-right commander" name="modifier" type="submit">Modifier</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- .col -->
...
<div class="modal fade" id="modalForm">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="#" class="form-validate is-alter" id="form_fournisseur" method="$_POST">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        load_panier_data();
        // load_panier_data_slect()
        // function load_panier_data_slect()
        // {
        //     $.ajax({
        //         url:"<?=ROOT?>/selectData_ajax/dataselectCommande",
        //         method:"POST",
        //         dataType:"json",
        //         success:function(data)
        //         {
        //             $('#ajout_tbody tr:last').before(data);
        //             total();
        //         }
        //     });
        // }
        ...
        $('#commande_ajout').on('submit',function (even) {
            ...
            if(idMedicement!=="" && idFournisseur!==""){
                $.ajax({
                    url:"<?=ROOT?>/Commandes/editStore",
                    method:'POST',
                    data:{idMedicement:idMedicement,quantite:quantite,idFournisseur:idFournisseur,edit:edit,total:total},
                    dataType:'JSON',
                    success:function(data){
                        // alert(data.Commande)

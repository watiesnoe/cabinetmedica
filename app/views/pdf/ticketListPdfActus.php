...
$output.='
    ...
    if ($patient->sexe=="" || $patient->resultatConsultation=="" || $patient->ethniPatient==""||$patient->telephonePat==""){
        ...
        $output.='  <tr>
                        ...
                        <td class="text-center" style="border: 1px solid; padding:6px; font-size:10px;">'.date('d-m-Y', strtotime($patient->dateDebut)).'</td>
                        <td class="text-center" style="border: 1px solid; padding:6px; font-size:10px;">'.date('d-m-Y', strtotime($patient->dateDebut.' +10 day')).'</td>

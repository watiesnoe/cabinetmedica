                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="hidden" class="form-control" name="edit" id="edit" aria-describedby="helpId" placeholder="" value="<?=$rdv?>">
                                                                <input type="hidden" class="form-control" name="patient" id="patient" aria-describedby="helpId" placeholder="" value="<?=$datas->idpatient?>">
                                                           
                                                                    <label for="resultat_clinique">Resultat du bilan de l'examen clinique</label>
                                                                    <textarea name="resultat_clinique" id="resultat_clinique" cols="10" rows="1" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="">Diagnostique</label>
                                                                    <textarea name="diagnostique" id="diagnostique" cols="10" rows="1" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="antecedant_medicaux">Antécédents Medicaux</label>
                                                                    <textarea name="antecedant_medicaux" id="antecedant_medicaux" cols="5" rows="2" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <textarea name="antecedant_chirigicale" id="antecedant_chirigicale" cols="5" rows="2" class="form-control"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <textarea name="antecedant_familiale" id="antecedant_familiale" cols="5" rows="2" class="form-control"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <textarea name="antecedant_autre" id="antecedant_autre" cols="5" rows="2" class="form-control"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script>
    $(document).ready(function(){
        $('#consultationticket').on('submit',function (even) {
            ...
            if( edit !=='' && resultat_clinique !== '' && diagnostique!==''){

                // window.setTimeout(location.reload(),6000)
                $.ajax({
                        url:"<?=ROOT?>/Consultations/Store_rdv",
                        method:'POST',
                        data:{
                        resultat_clinique:resultat_clinique,patient:patient,diagnostique:diagnostique,edit:edit,

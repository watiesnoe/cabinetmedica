...
EOT;
    ...
    protected function o_procset($id, $action, $options = '')
    {
        ...
        switch ($action) {
            case 'new':
                $this->objects[$id] = ['t' => 'procset', 'info' => ['PDFS' => 1, 'Text' => 1]];
        ...
        switch ($action) {
            ...
            case 'out':
                ...
                if (isset($o['procset'])) {
                    ...
                    $res .= "\n/ProcSet [/PDFS /Text /ImageB /ImageC /ImageI]";
                }
    ...
    /**
     * Embeds a file inside the PDFS
     *
     * @param string $filepath path to the file to store inside the PDFS
    ...
    /**
     * Add JavaScript code to the PDFS document
     *
     * @param string $code
     */

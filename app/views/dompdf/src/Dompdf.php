...
/**
 * Dompdf - PHP5 HTML to PDFS renderer
 *
 * Dompdf loads HTML and does its best to render it as a PDFS.  It gets its
 ...
 * the {@link Dompdf\Adapter\CPDFS} class provides a simple, stateless interface to
 * PDFS generation.)  PDFLib support has now also been added, via the {@link
...
class Dompdf
{
    ...
    /**
     * The default view of the PDFS in the viewer
     *
     * @var string
     */
    ...
    /**
     * The default view options of the PDFS in the viewer
     *
     * @var array
     */
    ...
    */
    ...
    /**
     * Add meta information to the PDFS after rendering
     */
    ...
    /**
     * Streams the PDFS to the client.
     *

 ...
 *
 * Dompdf\Adapter\CPDFS provides a simple stateless interface to the stateful one
...
class CPDF implements Canvas
{
     ...
     * Class constructor
     *
     * @param mixed $paper The size of paper to use in this PDFS ({@link CPDF::$PAPER_SIZES})
    ...
    /**
     * Returns the PDFS's width in points
     * @return float
     */
    ...
    /**
     * Returns the PDFS's height in points
     * @return float
     */

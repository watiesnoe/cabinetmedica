...
class PDFLib implements Canvas
{
    ...
    /**
     * List of gstate objects created for this PDFS (for reuse)
     *
     * @var array
     */
    protected $_gstates = [];
    ...
    /**
     * Add meta information to the PDFS
     *
    ...
    {
        // TODO: we should check the current PDFS stroke color
    ...
    {
        // TODO: we should check the current PDFS fill color
        // instead of the cached value
    ...
    protected function _load_font($font, $encoding = null, $options = "")
    {
        ...
        // Check if the font is a native PDFS font
    ...
    public function stream($filename = "document.pdf", $options = [])
    {
        ...
        if (self::$IN_MEMORY) {
            ...
            if (!$fh) {
                throw new Exception("Unable to load temporary PDFS file: " . $this->_file);
            }
